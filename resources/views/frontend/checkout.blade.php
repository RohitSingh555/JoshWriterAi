    ...
    <section>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 ">
                    <div class="card ">
                        <div class="card-body p-5" style="background: #22D4C4; border-radius:20px;">
                            <!-- Display a payment form -->
                            <form id="payment-form" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}">
                                ...
                                <div class="col-12 mt-5 d-flex justify-content-around w-100">
                                    ...
                                    <button class="btn  px-5 btn-primary " id="submit">
